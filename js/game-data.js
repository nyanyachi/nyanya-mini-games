(function () {
  ...
  const publicGames = [
    ...
    { title: "Sliding Puzzle", description: "Slide numbered tiles in this classic 15 puzzle and restore the board in the correct order.", image: "mini-game-site/apps/optimized/sliding-puzzle.webp", url: "games/sliding-puzzle.html", category: "puzzle", difficulty: "medium", playTime: "5-10 min", isNew: true, isPopular: false },
    { title: "Tower of Hanoi", description: "Move the tower to the final peg while following the classic disk-stacking logic puzzle rules.", image: "mini-game-site/apps/optimized/tower-of-hanoi.webp", url: "games/tower-of-hanoi.html", category: "puzzle", difficulty: "medium", playTime: "5-10 min", isNew: true, isPopular: false },
